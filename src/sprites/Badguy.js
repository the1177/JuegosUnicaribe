class Badguy extends Phaser.Physics.Arcade.Sprite {
    ...
    constructor(scene, x, y, key, frame, facing) {
        ...
        this.setOffset(12, 24, true);
        this.setCollideWorldBounds(true);

        // tweak stuff
        this.speedMax = 250;
        this.speedChange = 100;
        this.jumpPower = 500;
        ...
        if (!anims.get('idle-left')) {
            anims.create({
                key: 'idle-left',
                frames: anims.generateFrameNumbers('badguy', { start: 0, end: 0 }),
                frameRate: 10,
                repeat: -1
            });
        }
        if (!anims.get('idle-right')) {
            anims.create({
                key: 'idle-right',
                frames: anims.generateFrameNumbers('badguy', { start: 6, end: 6 }),
                frameRate: 10,
                repeat: -1
            });
        }
        if (!anims.get('run-left')) {
            anims.create({
                key: 'run-left',
                frames: anims.generateFrameNumbers('badguy', { start: 2, end: 4 }),
                frameRate: 10,
                repeat: -1
            });
        }
        if (!anims.get('run-right')) {
            anims.create({
                key: 'run-right',
                frames: anims.generateFrameNumbers('badguy', { start: 7, end: 9 }),
                frameRate: 10,
                repeat: -1
            });
        }
        ...
        if (!anims.get('flail-left')) {
            anims.create({
                key: 'flail-left',
                frames: anims.generateFrameNumbers('badguy', { start: 9, end: 9 }),
                frameRate: 10,
                repeat: -1
            });
        }
        if (!anims.get('flail-right')) {
            anims.create({
                key: 'flail-right',
                frames: anims.generateFrameNumbers('badguy', { start: 4, end: 4 }),
                frameRate: 10,
                repeat: -1
            });
        }
        if (!anims.get('slide-left')) {
            anims.create({
                key: 'slide-left',
                frames: anims.generateFrameNumbers('badguy', { start: 10, end: 10 }),
                frameRate: 10,
                repeat: -1
            });
        }
        if (!anims.get('slide-right')) {
            anims.create({
                key: 'slide-right',
                frames: anims.generateFrameNumbers('badguy', { start: 11, end: 11 }),
                frameRate: 10,
                repeat: -1
            });
        }
